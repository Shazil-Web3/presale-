...
`;
    ...
    class Simulation {
      ...
      getFloatType() {
        // Always prefer HalfFloatType for performance
      ...
      calcSize() {
        ...
        const resScale = isMobile ? this.options.resolution * 0.7 : this.options.resolution;
        const width = Math.max(1, Math.round(resScale * Common.width));
        const height = Math.max(1, Math.round(resScale * Common.height));
