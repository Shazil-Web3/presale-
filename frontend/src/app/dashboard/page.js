    ...
    >
      <div className="space-y-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          {/* Allocation Status */}
          <section className="quantum-panel rounded-[32px] p-10 relative overflow-hidden group border-white/5 bg-surface/30">
            <div className="absolute top-0 right-0 p-10 opacity-5 group-hover:opacity-10 transition-opacity">
              <ShieldCheck size={160} className="text-acid-lime" />
            </div>
            
            <div className="relative z-10 flex flex-col gap-10">
              <div className="flex flex-col md:flex-row items-center gap-10">
                <div className="relative flex items-center justify-center group/chart">
                  {/* Decorative rotating border */}
                  <div className="absolute inset-0 -m-4 pointer-events-none opacity-20 group-hover/chart:opacity-40 transition-opacity">
                    <div className="absolute inset-0 border-[1px] border-dashed border-white/20 rounded-full animate-[spin_30s_linear_infinite]" />
                  </div>

                  <svg className="h-40 w-40 transform -rotate-90 overflow-visible">
                    <defs>
                    ...
                    <motion.circle
                      ...
                      animate={{ strokeDashoffset: 440 * 0.25 }} // 75% progress
                  ...
                  <div className="absolute inset-0 flex flex-col items-center justify-center">
                    ...
                    >
                      <span className="text-[10px] text-muted-foreground uppercase tracking-[0.2em] font-bold mb-1">Status</span>
                      <span className="text-white font-bold text-3xl tracking-tighter">75<span className="text-acid-lime text-xl">%</span></span>
                    </motion.div>
                  </div>
                </div>
                ...
                <div className="flex-1 space-y-4 text-center md:text-left">
                  <div className="flex flex-wrap items-center gap-4 justify-center md:justify-start">
                    <h2 className="text-3xl font-bold tracking-tight text-foreground">1,050,000 BRX</h2>
              ...
              <div className="flex flex-wrap gap-8 pt-6 border-t border-white/5 justify-center md:justify-start">
                {[
                  ...
                  <div key={i} className="flex items-center gap-3">
                    ...
                    <span className={`text-xs font-medium ${step.status === 'done' ? 'text-foreground' : 'text-muted-foreground'}`}>{step.label}</span>
                  </div>
                ))}
              </div>
            </div>
          ...
          <section className="quantum-panel rounded-[32px] p-10 border-white/5 bg-surface/30">
            <div className="flex justify-between items-start mb-10">
              ...
              <div className="text-right space-y-1">
                ...
                <div className="text-lg font-mono font-bold text-acid-lime tracking-tight">05D : 11H : 42M</div>
              </div>
            </div>
            ...
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-2 gap-8 pt-8 border-t border-white/5">
                <div>
                  ...
                  <p className="text-xl font-bold text-foreground">24.5M BRX</p>
                </div>
                <div>
                  <p className="text-[10px] text-muted-foreground uppercase font-bold tracking-widest mb-1">Price</p>
                  <p className="text-xl font-bold text-acid-lime">$0.005</p>
                </div>
              </div>
            </div>
          </section>
        ...
        <section className="quantum-panel rounded-[32px] overflow-hidden border-white/5 bg-surface/30">
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left">
              <thead className="bg-white/[0.01] text-[10px] uppercase tracking-widest text-muted-foreground font-bold border-b border-white/5">
                <tr>
                  <th className="px-10 py-5">Hash</th>
              ...
              <tbody className="divide-y divide-white/5">
                {transactions.map((tx, i) => (
                  <tr key={i} className="group hover:bg-white/[0.015] transition-colors">
                    <td className="px-10 py-6 font-mono text-xs text-muted-foreground group-hover:text-acid-lime transition-colors cursor-pointer">{tx.hash}</td>
          ...
          <div className="p-6 bg-white/[0.005] border-t border-white/5 text-center">
